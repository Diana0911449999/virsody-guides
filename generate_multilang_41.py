...
POSTER_SOURCE = ROOT / "poster-41-source.jpg"
VOICES = {code: helper.VOICES[code] for code in ("zh-TW", "en-US", "ja-JP")}


def load_languages():
    html = (ROOT / "41-formal.html").read_text(encoding="utf-8")
...
def main():
    ...
    (OUT / "languages-41.js").write_text(
        ...
        encoding="utf-8")
    shutil.copy2(POSTER_SOURCE, OUT / "poster-41.jpg")
    html = (OUT / "40.html").read_text(encoding="utf-8")
